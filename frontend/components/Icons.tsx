...
export const IconVideo = makeIcon('lucide:video')
export const IconBellOff = makeIcon('lucide:bell-off')
export const IconBus = makeIcon('lucide:bus')
export const IconBriefcase = makeIcon('lucide:briefcase')
export const IconStar = makeIcon('mdi:star')
export const IconStarOutline = makeIcon('mdi:star-outline')
export const IconSave = makeIcon('lucide:save')
export const IconLink = makeIcon('lucide:link')
export const IconBot = makeIcon('lucide:bot')
export const IconClipboard = makeIcon('lucide:clipboard-list')
